...
-- TODO #1.1
cubes n d = Union [Cuboid n n n, Shift (n+d) (n+d) (Cuboid n n n),
                   Shift (n+d) 0 (Cuboid n n n), Shift 0 (n+d) (Cuboid n n n)]
...
instance Functor Bush where
  ...
  fmap f (Fork bs) =  Fork (map (fmap f) bs)
...
build ((width,depth), pos) = (Cuboid (width-5) (depth-5) (0.2054*(width * depth)), pos)
