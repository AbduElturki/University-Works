...
>   | a < 0 || b < 0 || c < 0 || a == 0 || b == 0 || c == 0 = Illegal
>   | a + b < c || a + c < b || b + c < a = Impossible
>   | a+b == c || a+c == b || b+c == a = Flat
>   | a == b && b == c = Equilateral
>   | a == b || a == c || b == c = Isosceles
>   | (a*a)+(b*b) == (c*c) || (a*a)+(c*c) == (b*b) || (c*c)+(b*b) == (a*a) = RightAngled
>   | a /= b && a /= c && b /= c = Scalene
...
> isiso :: Triple -> Bool
> isiso t = (triangle t == Isosceles)

> ex1 :: Int -> Int
> ex1 n = length (filter isiso(take n (triangles))) -- TODO: Should produce the number of Isosceles triangles in the first n triangles
...
> ex2 :: Int -> Int
> ex2 n = floor(sum(take n(map area triangles)))
...
> isSca :: Triple -> Bool
> isSca t = (triangle t == Scalene)

> ex3 :: Int -> Int
> ex3 n = floor(sum(take n(map area (filter isSca triangles))))
